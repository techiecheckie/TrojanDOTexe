...
dialogbox2 = instance_create(300, 50, obj_dialogbox);
with (dialogbox2) {
    dialogbox_set_text("Terms of Service ('Terms') #
Last updated: November 13, 2016 #
Please read these Terms of Service ('Terms', 'Terms of Service') carefully before #
using ActiveX (the 'Service') operated by trojanDOTexe ('us', 'we', or 'our').
...
or controlled by trojanDOTexe.
trojanDOTexe has no control over, and assumes no responsibility for, the content, #
privacy policies, or practices of any third party web sites or services. You further #
acknowledge and agree that trojanDOTexe shall not be responsible or liable, directly or indirectly, #
...
#
Governing Law #
These Terms shall be governed and construed in accordance with the laws of New York, United States, #
...
time. If a revision is material we will try to provide at least 30 microsecond notice prior #
to any new terms taking effect. What constitutes a material change will be determined 
at our sole discretion. #
By continuing to access or use our Service after those revisions become #
effective, you agree to be bound by the revised terms implemented just now, letting you know
we are uploading a virus to your computer as of this moment. Enjoy not reading the
...
");
    ...
    // add all the buttons
    dialogbox_add_button("Back", scr_TOS_tearDown);
